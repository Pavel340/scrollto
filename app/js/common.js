...
let topp = (windowHeight - liheight)/2;
let factor = windowHeight/liheight;
let maxScroll = ($('.main_scroller').height() - windowHeight)/factor;

let isScrolling = false;

let clip = 'rect('+topp+'px,'+windowWidth+'px,'+(topp+liheight)+'px,0)';
...
document.addEventListener('wheel',function(event) {
  ...
  TweenLite.to('.main_scroller',0.5,{
	y:-currentS*factor,
